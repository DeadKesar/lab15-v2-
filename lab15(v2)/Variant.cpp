...
void Variant::Converse(Types type)
{
	try {
		...
		case string:
			...
			break;
		case charr:
			this->str = this->ToChar();
			this->var = charr;
			break;
		case intt:
			this->str = std::to_string(this->ToInt());
			this->var = intt;
			break;
		case floatt:
			this->str = std::to_string(this->ToFloat());
			this->var = floatt;
			break;
		case doublee:
			this->str = std::to_string(this->ToDouble());
			this->var = doublee;
			break;
		case booll:
			this->str = std::to_string(this->ToBool());
			if (this->str == "1")
			{
				this->str = "true";
			}
